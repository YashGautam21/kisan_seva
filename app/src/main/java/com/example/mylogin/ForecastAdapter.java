...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ViewHolder> {
    private List<com.example.mylogin.models.List> forecastWeatherModelList;
    public ForecastAdapter(List<com.example.mylogin.models.List> forecastWeatherModelList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        com.example.mylogin.models.List fcWeather = forecastWeatherModelList.get(position);
        ...
        if(iconFile != null) {
            if (!iconFile.isEmpty()) {
                ...
                holder.ivForecastIcon.setImageBitmap(BitmapFactory.decodeResource(CameraActivity.mContext.getResources(), imgId));
            } else {
