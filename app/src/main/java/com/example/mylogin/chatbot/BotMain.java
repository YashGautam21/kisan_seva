package com.example.mylogin.chatbot;
...
import com.example.mylogin.chatbot.adapter.MessageRVAdapter;
import com.example.mylogin.chatbot.data.Message;
...
public class BotMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bot_main);
        ...
        sendMsgIB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userMsgEdt.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(BotMain.this, "Please enter your message..", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void sendMessage(String userMsg) {
        ...
        String url = "http://api.brainshop.ai/get?bid=177990&key=8u1UyzfqFzNa3kJh&uid=[uid]&msg="+userMsg;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(BotMain.this, "No response from the bot..",Toast.LENGTH_SHORT).show();
            }
        });
